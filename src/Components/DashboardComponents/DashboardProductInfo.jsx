...
const DashboardProductInfo = () => {
  return (
    ...
    <div>
      ...
      <span style={{fontSize:"0.6rem", color:"#B5B5B5", fontWeight:"700", marginLeft:"7px"}}>0  </span>
      <span style={{fontSize:"0.6rem", color:"#B5B5B5", fontWeight:"700", marginLeft:"7px"}}> Speakers </span>
      </Box>
